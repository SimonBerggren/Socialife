 ...
 */
public class GroupViewAnimated extends ExpandableListView {
    ...
    public GroupViewAnimated(Context context) {
        super(context);
    }

    public GroupViewAnimated(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public GroupViewAnimated(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private GroupViewAnimated parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(GroupViewAnimated parent) {
            this.parent = parent;
        }
